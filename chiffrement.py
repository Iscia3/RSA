...
def encrypt(public_key: couple[int,int], message: bytes) -> list[int]: # la clée public est un paramètre explicite
    e, n = public_key # couple (e,n) pour gérer proprement la clée publique
    encrypted= []
    for b in message:
